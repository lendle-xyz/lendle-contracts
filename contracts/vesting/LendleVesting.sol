 ...
 * @author Lendle Team
 */
contract LendleVesting is Ownable, ReentrancyGuard {
     ...
     * @param token_ address of the LEND token contract
     */
    ...
    /**
     * @dev Returns the address of the LEND token managed by the vesting contract.
     */
